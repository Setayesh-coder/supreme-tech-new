...
export default function PaymentDetailsModal({
  ...
  // ✅ داده‌های نمونه برای تصویر رسید
  // در آینده این را از API دریافت کنید
  const receiptImage = "/uploads/receipts/sample-receipt.jpg";
  const trackingCode = "TRK-12345678";
