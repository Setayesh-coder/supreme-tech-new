  ...
  return (
    <>
      <MotionComponent
        ...
        {...props}
      >
        {/* Bend Layer - این لایه رو pointer-events-none می‌کنیم تا کلیک رو نگیره */}
        <div
        ...
        {/* Face Layer - این لایه هم pointer-events-none */}
        <div
        ...
        {/* Edge Layer - این لایه هم pointer-events-none */}
        <div
        ...
        {/* Content - محتوا میتونه کلیک بخوره */}
